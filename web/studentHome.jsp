  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      %>
        ...
        <p><a href="viewProfileServlet?rd=<%= id %>" class="a1">Profile</a></p><br>
        <p><a href="showIssue?rd1=<%= id %>" class="a1">Books Issue</a></p><br>
        <p><a href="#" class="a1" data-toggle="modal" data-target="#myModal12">Check Fine</a></p><br>
    </div>
    <div class="col-sm-8 text-left"> 
        <img src="images\s3.jpg" class="i21">
    </div>
<!--    <div class="col-sm-2 sidenav">
      <div class="well">
      ...
      <div class="well">
        ...
        <div class="well">
            <button class="btn1" ><a href="viewBook" style="color:white;">Check Fine</a></button>
      </div>
   ...
   <div class="modal fade" id="myModal5" role="dialog">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">×</button>
          <h4><span class="glyphicon glyphicon-lock"></span> Student Fine</h4>
        </div>
        <div class="modal-body">
            <center> 
                <b>Your Fine Is :</b>
                <p class="pa"><b>0.0 Rs.</b></p>
            </center>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-danger btn-default pull-left" data-dismiss="modal">
