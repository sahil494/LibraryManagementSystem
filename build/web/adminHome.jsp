...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
        <img src="images\l3.jpg" class="i21">
    </div>
    <div class="col-sm-2 sidenav">
      <div class="well">
          <button class="btn1" data-toggle="modal" data-target="#myModal">Add Books</button>
      </div>
      <div class="well">
         <button class="btn1" data-toggle="modal" data-target="#myModal1">Search Book</button>
      </div>
        <div class="well">
         <button class="btn1" data-toggle="modal" data-target="#myModal4">Update Book</button>
      </div>
         <div class="well">
         <button class="btn1" data-toggle="modal" data-target="#myModal2">Delete Book</button>
      </div>
        <div class="well">
            <button class="btn1" ><a href="viewBook" style="color:white;">View Books</a></button>
      </div>
          <div class="well">
              <a href="viewStudentServlet">  <button class="btn1">Students Info</button></a>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span> Add Book Details</h4>
        </div>
        <div class="modal-body">
            <form action="addBookServlet" name="myform" role="form" method="post" onsubmit="return myValidation()">
            <div class="form-group">
                <label for="psw"><span class="glyphicon glyphicon-shopping-cart"></span>Book ID</label>
              <input type="text" name="bid" class="form-control" id="psw" placeholder="Enter Book ID">
            </div>
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span>Title</label>
              <input type="text" name="bt" class="form-control" id="usrname" placeholder="Enter Book Title">
            </div>
               <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span>Author Name</label>
              <input type="text" name="an" class="form-control" id="usrname" placeholder="Enter Author Name">
            </div>
               <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicosn-user"></span>Quantity</label>
              <input type="text" name="qa" class="form-control" id="usrname" placeholder="Enter Quantity">
            </div>
 ...
 <div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">×</button>
          <h4><span class="glyphicon glyphicon-lock"></span> Search Book Details</h4>
        </div>
        <div class="modal-body">
            <form action="searchServlet" name="myform1" role="form" method="post" onsubmit="return myValidation1()">
            <div class="form-group">
                <label for="psw"><span class="glyphicon glyphicon-shopping-cart"></span>Book ID</label>
            ...
            <div class="form-group">
              ...
              <center><button type="submit" class="btn btn-block">Search
                <span class="glyphicon glyphicon-ok"></span>
              </button>
              </center>
          </form>
...
The University has at the centre of its philosophical core the commitment to excellence in education. It is the strong academic heritage of the University, and such firmness on matters of principles that has seen it grow from strength to strength in such a short span of time.
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">×</button>
          <h4><span class="glyphicon glyphicon-lock"></span> Update Book Details</h4>
        </div>
        <div class="modal-body">
            <form action="updateBook" name="myform" role="form">
            <div class="form-group">
                <label for="psw"><span class="glyphicon glyphicon-shopping-cart"></span>Book ID</label>
                <input type="text" name="bid" class="form-control" id="psw" placeholder="Enter Book ID" required>
            </div>
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span>Title</label>
              <input type="text" name="bt" class="form-control" id="usrname" placeholder="Enter Book Title" required>
            </div>
               <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span>Author Name</label>
              <input type="text" name="an" class="form-control" id="usrname" placeholder="Enter Author Name" required>
            </div>
               <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicosn-user"></span>Quantity</label>
              <input type="text" name="qa" class="form-control" id="usrname" placeholder="Enter Quantity" required>
            </div>
              <center><button type="submit" class="btn btn-block">Submit
                <span class="glyphicon glyphicon-ok"></span>
              </button>
